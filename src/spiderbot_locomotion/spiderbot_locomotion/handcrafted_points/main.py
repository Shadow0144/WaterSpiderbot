"""Runs a node for locomoting a Spiderbot using hand-crafted points."""

import rclpy
from rclpy.executors import ExternalShutdownException

from .handcrafted_points_locomotion_node import HandCraftedPointsLocomotionNode
...
def main(args=None):
    ...
    try:
        locomotion_node = HandCraftedPointsLocomotionNode()
