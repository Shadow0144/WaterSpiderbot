"""Runs a node for locomoting a Spiderbot using a simple sin function."""

import rclpy
from rclpy.executors import ExternalShutdownException

from .simple_sin_locomotion_node import SimpleSinLocomotionNode
...
def main(args=None):
    ...
    try:
        locomotion_node = SimpleSinLocomotionNode()
